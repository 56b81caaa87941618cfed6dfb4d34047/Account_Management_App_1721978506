Vue.component('contact_form_1721978557', {
  template: `
    <main class="flex justify-center align-center p-10">
      <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
        <div>
          <h3 class="text-black font-semibold text-xl">Get in Touch for Seamless Accounting</h3>
          <p class="mt-3 text-black w-fit">Let's discuss how we can streamline your financial operations.</p>
        </div>
        <form @submit.prevent class="space-y-5 mt-5">
          ...
          <button class="w-full px-4 py-2 text-white font-medium bg-green-600 hover:bg-green-500 active:bg-green-700 rounded-lg duration-150">How Can We Assist You?</button>
        </form>
      </div>
    </main>
  `,
